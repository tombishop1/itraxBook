...
We'll use our `xrf` and `icp` data sets to create linear models of all the variables of interest. They must be combined using `pivot_longer()`. The plot indicates that some, but not all variables are suitable for calibration.
