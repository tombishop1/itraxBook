...
```{r image_import_0}
str(itrax_image(file = "CD166_19_S1/CD166_19_S1/optical.tif",
...
```{r radio_import_0}
str(itrax_radiograph(file = "CD166_19_S1/CD166_19_S1_RAD/radiograph0.tif",
...
```{r everything}
CD166_19_S1 <- list(metadata   = itrax_meta("document.txt"),
                    xrf        = itrax_import("Results.txt", depth = 0),
                    image      = itrax_image("optical.tif")$image,
                    radiograph = itrax_radiograph("radiograph0.tif")$image)
str(CD166_19_S1)
```
