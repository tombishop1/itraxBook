...
CD166_19_S1 <- itrax_import("CD166_19_S1/CD166_19_S1/Results.txt", depth = 0)
glimpse(CD166_19_S1) #%>% scroll_box(width = "100%")
```
...
```{r image_import_0}
glimpse(itrax_image(file = "CD166_19_S1/CD166_19_S1/optical.tif",
...
```{r radio_import_0}
glimpse(itrax_radiograph(file = "CD166_19_S1/CD166_19_S1_RAD/radiograph0.tif",
...
CD166_19_S2 <- list(metadata   = itrax_meta("CD166_19_S2/CD166_19_S2/document.txt"),
                    ...
                    radiograph = itrax_radiograph(file = "CD166_19_S2/CD166_19_S2_RAD/radiograph.tif",
...
CD166_19_S3 <- list(metadata   = itrax_meta("CD166_19_S3/CD166_19_S3/document.txt"),
                    ...
                    radiograph = itrax_radiograph(file = "CD166_19_S3/CD166_19_S3_RAD/radiograph.tif",
