...
```{r plot_image}
myImage <- itrax_image(file = "CD166_19_(2020)/CD166_19_S1/CD166_19_S1/optical.tif",
                       meta = "CD166_19_(2020)/CD166_19_S1/CD166_19_S1/document.txt",
                       trim = FALSE,
                       plot = TRUE
                       )
```
...
```{r itrax_image}
myRadio <- itrax_radiograph(file = "CD166_19_(2020)/CD166_19_S1/CD166_19_S1_RAD/radiograph0.tif",
                            meta = "CD166_19_(2020)/CD166_19_S1/CD166_19_S1_RAD/document.txt",
                            plot = TRUE
                            )
```
...
```{r overplot_sequence}
CD166_19_S1_optical <- itrax_image(file = "CD166_19_(2020)/CD166_19_S1/CD166_19_S1/optical.tif", 
                                   meta = "CD166_19_(2020)/CD166_19_S1/CD166_19_S1/document.txt")
CD166_19_S2_optical <- itrax_image(file = "CD166_19_(2020)/CD166_19_S2/CD166_19_S2/optical.tif", 
                                   meta = "CD166_19_(2020)/CD166_19_S2/CD166_19_S2/document.txt")
CD166_19_S3_optical <- itrax_image(file = "CD166_19_(2020)/CD166_19_S3/CD166_19_S3/optical.tif", 
                                   meta = "CD166_19_(2020)/CD166_19_S3/CD166_19_S3/document.txt")

ggplot() +
  ylim(rev(range(CD166_19$depth))) +
  scale_x_continuous(breaks = round(range(as.numeric(colnames(CD166_19_S1_optical$image))), 0),
                     limits = range(as.numeric(colnames(CD166_19_S1_optical$image)))) +
  coord_fixed(ratio = 1) +
  labs(y = "Depth [mm]", x = "[mm]") +
  annotation_custom(rasterGrob(CD166_19_S1_optical$image,
                               width = unit(1, "npc"),
                               height = unit(1, "npc")),
                    ymax = max(CD166_19[which(CD166_19$label == "S1"),]$depth)/-1,
                    ymin = min(CD166_19[which(CD166_19$label == "S1"),]$depth)/-1,
                    xmin = min(as.numeric(colnames(CD166_19_S1_optical$image))),
                    xmax = max(as.numeric(colnames(CD166_19_S1_optical$image)))
  ) +
  annotation_custom(rasterGrob(CD166_19_S2_optical$image,
                               width = unit(1, "npc"),
                               height = unit(1, "npc")),
                    ymax = max(CD166_19[which(CD166_19$label == "S2"),]$depth)/-1,
                    ymin = min(CD166_19[which(CD166_19$label == "S2"),]$depth)/-1,
                    xmin = min(as.numeric(colnames(CD166_19_S2_optical$image))),
                    xmax = max(as.numeric(colnames(CD166_19_S2_optical$image)))
  ) +
  annotation_custom(rasterGrob(CD166_19_S3_optical$image,
                               width = unit(1, "npc"),
                               height = unit(1, "npc")),
                    ymax = max(CD166_19[which(CD166_19$label == "S3"),]$depth)/-1,
                    ymin = min(CD166_19[which(CD166_19$label == "S3"),]$depth)/-1,
                    xmin = min(as.numeric(colnames(CD166_19_S3_optical$image))),
                    xmax = max(as.numeric(colnames(CD166_19_S3_optical$image)))
  )
```
...
ggplot() +
  ylim(rev(range(CD166_19$depth))) +
  xlim(0, max(as.numeric(colnames(CD166_19_S2_optical$image)))*2) +
  coord_fixed(ratio = 1) +
  labs(y = "Depth [mm]") +
  ...
  annotation_custom(rasterGrob(CD166_19_S2_optical$image,
                    ...
                    ymax = max(CD166_19[which(CD166_19$label == "S2"),]$depth)/-1,
                    ymin = min(CD166_19[which(CD166_19$label == "S2"),]$depth)/-1,
                    xmin = max(as.numeric(colnames(CD166_19_S2_optical$image))),
                    xmax = max(as.numeric(colnames(CD166_19_S2_optical$image)))*2
  ) +
  annotation_custom(rasterGrob(CD166_19_S3_optical$image,
                               width = unit(1, "npc"),
                               height = unit(1, "npc")),
